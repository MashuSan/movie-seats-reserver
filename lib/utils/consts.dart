...
import '../models/movie_item.dart';
  ...
  const kApiKey = '87aa7f6d31ca973d0716d15bc0317161';
  ...
  const Color textColor = const Color(0xFF2C3F58);
  const Color inactiveColor = const Color(0xFFD7E1EA);

  getFavoriteCollection(collection) => 'favorite_$collection';
